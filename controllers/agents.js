...
/**
 * @api {get} /agents/:agent_id/sys Get syscollector info
 * @apiName GetSyscollector
 * @apiGroup Syscollector
 *
 * @apiParam {Number} agent_id Agent ID.
 *
 * @apiDescription Returns the agent's syscollector info
 *
 * @apiExample {curl} Example usage*:
 *     curl -u foo:bar -k -X GET "https://127.0.0.1:55000/agents/003/sys?pretty"
 *
 */
router.get('/:agent_id/sys', function(req, res) {
